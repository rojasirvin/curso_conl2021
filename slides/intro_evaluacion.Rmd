...
La pregunta de evaluación es encontrar la magnitud del cambio $\phi(W(1-t'),X,U)-\phi(W(1-t),X,U)$ para cada individuo
...
1. El impuesto ha existido antes, pero queremos conocer su efecto en una población distinta, con una distribución distinta de $(W,X,U)$
