---
title: "Métodos no experimentales"
author: "Irvin Rojas"
header-includes:
  - \usepackage{tikz}
...
knitr::include_graphics("figures/dd_empleo.png")
```
...
.pull-right[
```{r, out.width="100%",fig.cap='Fuente: Gertler et al. (2017)',fig.align='center'}
knitr::include_graphics("figures/arroz_produccion.png")
```
]
---
...
.pull-right[
```{r, out.width="100%",fig.cap='Fuente: Gertler et al. (2017)',fig.align='center'}
knitr::include_graphics("figures/arroz_rd.png")
```
]
...
Cuando tenemos datos a nivel individual de individuos tratados y no tratados podemos usar 
...
$$
\text{Efecto de tratamiento}=E_{P(X)|D=1} \left(E(Y(1)|D=1, P(X))-E(Y(0)|D=0,P(X)) \right)
$$
 
El efecto del tratamiento es la diferencia en la variable de resultados de los tratados y los no tratados pesada por la distribución del PS en los tratados
